...
%     point2 = robot.ik3001(point2);
    ...
    dlmwrite('trajData7_pos_TaskSpace_quintic.csv',data1,'delimiter',',');
    dlmwrite('trajData7_pos_TaskSpace_quintic.csv',data2,'delimiter',',','-append');
    dlmwrite('trajData7_pos_TaskSpace_quintic.csv',data3,'delimiter',',','-append');
...
function quintic_TS(robot)
    ...
    dlmwrite('trajData6_pos_TaskSpace_cubic.csv',data1,'delimiter',',');
    dlmwrite('trajData6_pos_TaskSpace_cubic.csv',data2,'delimiter',',','-append');
    dlmwrite('trajData6_pos_TaskSpace_cubic.csv',data3,'delimiter',',','-append');
